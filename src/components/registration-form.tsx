  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: (error as Error).message || "There was a problem with your registration.",
      });
    } finally {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField
                            ...
                            <FormItem>
                                <FormLabel>Age</FormLabel>
                                <FormControl>
                                <Input type="number" placeholder="18" {...field} onChange={e => field.onChange(e.target.value === '' ? undefined : +e.target.value)} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                            )}
